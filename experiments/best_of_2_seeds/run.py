"""
Run script for best_of_2_seeds experiment.

Tests running 2 independent CMA-ES instances with different seeds.
"""
...
from optimizer import BestOf2SeedsOptimizer
...
def process_single_sample(args):
    ...
    optimizer = BestOf2SeedsOptimizer(
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"BEST OF 2 SEEDS EXPERIMENT")
    print(f"{'='*60}")
    print(f"Samples: {n_samples} ({n_1src} 1-source, {n_2src} 2-source)")
    print(f"Workers: {args.workers}")
    print(f"Seeds: {args.n_seeds}")
    print(f"Fevals: {args.fevals_1src} for 1-src, {args.fevals_2src} for 2-src")
    print(f"{'='*60}")
    ...
    print(f"\n{'='*70}")
    print(f"RESULTS - Best of {args.n_seeds} Seeds")
    print(f"{'='*70}")
