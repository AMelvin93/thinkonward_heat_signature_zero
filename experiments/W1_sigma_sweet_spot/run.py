#!/usr/bin/env python3
"""
Run script for W1 Sigma Sweet Spot optimizer.

EXP001: Testing intermediate thresholds with proven high sigma.
Config:
- sigma0_1src: 0.20
- sigma0_2src: 0.25
- threshold_1src: 0.38
...
def main():
    parser = argparse.ArgumentParser(description='Run W1 Sigma Sweet Spot optimizer')
    ...
    print(f"\nW1 Sigma Sweet Spot Optimizer (EXP001)")
    print(f"=" * 60)
    ...
    print(f"\n{'='*70}")
    print(f"RESULTS: W1 Sigma Sweet Spot (EXP001)")
    print(f"{'='*70}")
