#!/usr/bin/env python3
"""
Run script for Simple Top 3 No Dissimilarity experiment.

Tests the hypothesis that dissimilarity filtering is not needed because
the top 3 candidates by RMSE are naturally distinct enough.

Based on W2's baseline (40% temporal, sigma 0.18/0.22, 8 NM polish).
"""
...
def main():
    parser = argparse.ArgumentParser(description='Run Simple Top 3 No Dissimilarity experiment')
    ...
    # Sigma (using W2's optimal values)
    ...
    if not args.no_mlflow:
        ...
        mlflow.set_experiment('simple_top3_no_dissimilarity')
