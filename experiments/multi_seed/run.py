#!/usr/bin/env python3
"""
Run script for Multi-Seed optimizer.
"""
...
from optimizer import MultiSeedOptimizer


def process_single_sample(args):
    idx, sample, meta, config = args
    optimizer = MultiSeedOptimizer(
...
def main():
    parser = argparse.ArgumentParser(description='Run Multi-Seed optimizer')
