"""
W1 Baseline Reduced Fevals V2 Optimizer.

EXP026: Baseline sigma with reduced fevals and slightly lower thresholds.
Goal: Stay in budget (<60 min) while potentially gaining some score.
...
class BaselineReducedFevalsOptimizer:
    """
    Optimizer with sigma 0.18/0.22 - re-verification of EXP010.

    EXP018 Config (same as EXP010):
    - sigma0_1src: 0.18 (the only higher sigma that works!)
    - sigma0_2src: 0.22
    - threshold_1src: 0.35
    - threshold_2src: 0.45
    - fevals_1src: 20
    ...
    def __init__(
        ...
        sigma0_1src: float = 0.18,      # Re-verifying EXP010
        sigma0_2src: float = 0.22,      # Re-verifying EXP010
