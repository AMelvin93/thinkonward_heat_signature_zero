...
3-run validation of the no_perturb config to establish reliability.
This is the ONLY config that fits budget on the current system.
"""
...
def main():
    ...
    # NO PERTURBATION CONFIG - the only in-budget option
    config = {
        'sigma0_1src': 0.18,
        'sigma0_2src': 0.22,
        'max_fevals_1src': 20,
    ...
    print("=" * 70)
    print("NO_PERTURB VALIDATION (3 runs)")
    print("=" * 70)
    print("This is the ONLY config that fits budget on this system.")
    print("Previous single run: Score=1.1367, Time=56.3 min")
    ...
    print("\n" + "=" * 70)
    print("VALIDATION SUMMARY: no_perturb (3 runs)")
    print("=" * 70)
    print(f"\nRun Results:")
    for r in results:
