#!/usr/bin/env python3
"""
Run script for Differential Evolution optimizer.
"""
...
def main():
    ...
    parser.add_argument('--maxiter-1src', type=int, default=8)
    parser.add_argument('--maxiter-2src', type=int, default=12)
    ...
    print(f"Recombination: {args.recombination}, Polish: {args.polish}")
    ...
    print(f"This run: {score:.4f} @ {projected_400:.1f} min (DE)")
    print(f"Delta:    {score - 1.1247:+.4f} score, {projected_400 - 57.2:+.1f} min")
    print()

    # Success criteria check
    success = score >= 1.10 and projected_400 <= 55
    abandon = score < 1.05 or projected_400 > 65
