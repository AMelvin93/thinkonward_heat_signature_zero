"""
W1 Very Reduced Primary Fevals Optimizer.
...
Config:
- sigma0_1src: 0.20 (high sigma)
- sigma0_2src: 0.25 (high sigma)
- threshold_1src: 0.35
- threshold_2src: 0.45
...
class VeryReducedFevalsOptimizer:
    """
    Optimizer with high sigma and very reduced primary fevals.

    EXP011 Config:
    - sigma0_1src: 0.20 (high sigma for better exploration)
    - sigma0_2src: 0.25 (high sigma for better exploration)
    - threshold_1src: 0.35
    - threshold_2src: 0.45
    - fevals_1src: 16 (reduced from 20)
    - fevals_2src: 30 (reduced from 36)
    ...
    Hypothesis: More aggressive fevals reduction (16/30 vs 18/32) may save
    enough time (~4-5 min) to hit budget while preserving high sigma benefits.
    """
    ...
    def __init__(
        ...
        max_fevals_2src: int = 30,       # Reduced from 36
        sigma0_1src: float = 0.20,       # High sigma
        sigma0_2src: float = 0.25,       # High sigma
