"""
Test: 5 perturbations with nm_iters=1

Previous best (4pert nm2 scale06):
- Mean: 1.1549 @ 57.5 min
- Best: 1.1612 (BEATS TOP 10!)

Hypothesis: 5 perturbations with minimal nm might push score even higher
"""
...
def main():
    ...
    config = {
        ...
        'n_perturbations': 5,  # INCREASED to 5
        'perturbation_scale': 0.06,
        'perturb_nm_iters': 1,  # MINIMAL
        'tabu_distance': 0.04,
        'max_tabu_attempts': 10,
    }

    print("=" * 70)
    print("TEST: 5pert_nm1 scale06")
    print("=" * 70)
    print("Config: 5 perturbations, nm_iters=1, scale=0.06")
    print()
    print("Previous 4pert nm2 scale06 result:")
    print("  Mean: 1.1549 @ 57.5 min")
    print("  Best: 1.1612 (BEATS TOP 10!)")
    print()
    print("Hypothesis: More exploration with 5 perturbations")
    print("=" * 70)
    ...
    if result['in_budget'] and result['score'] >= 1.1549:
        ...
        with open('test_5pert_nm1_output.json', 'w') as f:
            json.dump({
                'config': '5pert_nm1_scale06',
        ...
        with open('test_5pert_nm1_output.json', 'w') as f:
            json.dump({'config': '5pert_nm1_scale06', 'result': 'OVER BUDGET', 'run': result}, f, indent=2)
    else:
        print("\n*** Score worse than 4pert nm2 - not worth validating ***")
        with open('test_5pert_nm1_output.json', 'w') as f:
            json.dump({'config': '5pert_nm1_scale06', 'result': 'WORSE THAN BEST', 'run': result}, f, indent=2)

    print("\nResults saved to test_5pert_nm1_output.json")
