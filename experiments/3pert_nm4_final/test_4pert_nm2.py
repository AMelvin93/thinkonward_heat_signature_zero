"""
Test: 4 perturbations with nm_iters=2

Previous best (3pert nm3 scale06):
- Mean: 1.1506 @ 55.9 min
- Best: 1.1581 (gap: 0.0004 to Top 10!)

Hypothesis: 4 perturbations with reduced nm_iters might push score higher
"""
...
def main():
    ...
    config = {
        ...
        'n_perturbations': 4,  # INCREASED to 4
        'perturbation_scale': 0.06,
        'perturb_nm_iters': 2,  # REDUCED to 2
        'tabu_distance': 0.04,
        'max_tabu_attempts': 10,
    }

    print("=" * 70)
    print("TEST: 4pert_nm2 scale06")
    print("=" * 70)
    print("Config: 4 perturbations, nm_iters=2, scale=0.06")
    print()
    print("Previous 3pert nm3 scale06 result:")
    print("  Mean: 1.1506 @ 55.9 min")
    print("  Best: 1.1581 (gap: 0.0004)")
    print()
    print("Hypothesis: More exploration opportunities with 4 perturbations")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("VALIDATION SUMMARY: 4pert_nm2 scale06 (3 runs)")
    print("=" * 70)
    ...
    print(f"\nComparison:")
    print(f"  vs 3pert nm3 scale06 (1.1506): {mean_score - 1.1506:+.4f}")
    ...
    with open('test_4pert_nm2_output.json', 'w') as f:
        json.dump({
    ...
    print("\nResults saved to test_4pert_nm2_output.json")
