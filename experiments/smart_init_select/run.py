#!/usr/bin/env python3
"""
Run script for Smart Init Selection optimizer.
"""
...
from optimizer import SmartInitSelectOptimizer


def process_single_sample(args):
    idx, sample, meta, config = args
    optimizer = SmartInitSelectOptimizer(
        ...
        n_inits_to_use=config.get('n_inits_to_use', 2),
    )
    start = time.time()
    try:
...
def main():
    ...
    print(f"Use best {args.n_inits} inits for CMA-ES")
