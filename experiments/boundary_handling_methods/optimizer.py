"""
Boundary Handling Methods Optimizer

Tests different CMA-ES boundary constraint handling methods:
1. BoundTransform (default) - smooth piecewise linear/quadratic transformation
2. BoundPenalty - adds penalty for constraint violations

Key difference: Different approaches to handling box constraints during CMA-ES.
"""
...
class BoundaryHandlingOptimizer:
    """
    Tests different CMA-ES boundary handling methods.

    BoundaryHandler options:
    - 'BoundTransform' (default): Smooth transformation into feasible domain
    - 'BoundPenalty': Penalty-based constraint handling
    """
    ...
    def __init__(
        ...
        boundary_handler: str = 'BoundTransform',  # or 'BoundPenalty'
    ...
    def _run_single_optimization(self, sample, meta, q_range, solver_coarse, solver_fine,
        ...
        """Run optimization with specified boundary handling."""
        ...
        for init_params, init_type in initializations:
            ...
            # Set boundary handler
            opts['BoundaryHandler'] = self.boundary_handler
