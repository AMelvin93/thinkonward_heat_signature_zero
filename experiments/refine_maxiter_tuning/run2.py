"""
Validate refine_maxiter=6 as potential new best
"""
...
def run_experiment(config, run_num, data):
    ...
    print(f"\n=== Validation Run {run_num}: refine_maxiter=6 ===")
...
def main():
    ...
    run1 = {'run': 1, 'score': 1.1468, 'avg_n_cands': 2.84, 'projected_400_min': 34.5}
    ...
    print("\n" + "="*60)
    print("SUMMARY: Refine Maxiter=6 Validation")
    print("="*60)
    print(f"Previous best (maxiter=8): 1.1437 @ 42.2 min")
    print()
    for r in results:
