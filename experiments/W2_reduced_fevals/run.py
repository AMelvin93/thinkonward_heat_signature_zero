#!/usr/bin/env python3
"""
Run script for W2 Reduced Primary Fevals optimizer.

EXP008: reduced_primary_fevals
Config:
...
Hypothesis: Reduce PRIMARY fevals by ~10% to save ~10% time (~6-7 min) while keeping high sigma benefits.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Run W2 Reduced Fevals optimizer')
    parser.add_argument('--workers', type=int, default=7)
    parser.add_argument('--max-samples', type=int, default=None)
    parser.add_argument('--shuffle', action='store_true')
    parser.add_argument('--seed', type=int, default=42)
    # Key experiment parameters - EXP008 specific
    ...
    print(f"\n[W2] Reduced Primary Fevals Optimizer")
    print(f"=" * 70)
    print(f"EXP008: reduced_primary_fevals")
    print(f"-" * 70)
    ...
    print(f"\n{'='*70}")
    print(f"RESULTS: [W2] Reduced Primary Fevals (EXP008)")
    print(f"{'='*70}")
    ...
    print()
    print(f"Config: sigma={args.sigma0_1src}/{args.sigma0_2src}, thresh={args.threshold_1src}/{args.threshold_2src}")
    print(f"PRIMARY fevals: {args.max_fevals_1src}/{args.max_fevals_2src} (reduced)")
    print(f"Baseline: 1.1247 @ 57.2 min")
    print(f"Best ever: 1.1362 @ 69.2 min (EXP002)")
