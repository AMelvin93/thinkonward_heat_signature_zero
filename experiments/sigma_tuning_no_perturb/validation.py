"""
Experiment: sigma_015_019 Validation (3 runs)

Validate the sigma_015_019 no_perturb config which showed improvement.
Single run: 1.1405 @ 43.3 min
Baseline (0.18/0.22): 1.1386 @ 49.3 min
"""
...
def main():
    ...
    print("=" * 70)
    print("SIGMA_015_019 VALIDATION (3 runs)")
    print("=" * 70)
    print("Config: sigma 0.15/0.19 no_perturb")
    print("Previous single run: 1.1405 @ 43.3 min")
    print("Baseline (0.18/0.22): 1.1386 @ 49.3 min")
    ...
    print("\n" + "=" * 70)
    print("VALIDATION SUMMARY: sigma_015_019 (3 runs)")
    print("=" * 70)
    print(f"\nRun Results:")
    for r in results:
    ...
    print(f"\nComparison:")
    print(f"  vs baseline (0.18/0.22): {mean_score - 1.1386:+.4f}")
