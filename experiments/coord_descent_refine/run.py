#!/usr/bin/env python3
"""
Run script for Coordinate Descent Refinement experiment.

Usage:
    uv run python experiments/coord_descent_refine/run.py --workers 7 --shuffle
"""
...
from optimizer import CoordDescentRefineOptimizer


def process_single_sample(args):
    idx, sample, meta, config = args
    optimizer = CoordDescentRefineOptimizer(
...
def main():
    parser = argparse.ArgumentParser(description='Run Coordinate Descent Refinement')
    ...
    print(f"\nCoordinate Descent Refinement Experiment")
    print(f"=" * 60)
