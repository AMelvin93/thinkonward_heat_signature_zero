"""Full 80-sample test of minimal config (no perturbations)."""
...
def main():
    ...
    # MINIMAL CONFIG: No perturbations
    config = {
        'sigma0_1src': 0.18,
        'sigma0_2src': 0.22,
        'max_fevals_1src': 20,
    ...
    print("="*70)
    print("FULL 80-SAMPLE TEST: NO PERTURBATIONS (minimal)")
    print("="*70)
    ...
    print("="*70)
    print("RESULTS: NO PERTURBATIONS (minimal)")
    print("="*70)
    ...
    with open('full_test_minimal_output.json', 'w') as f:
        json.dump({
            'config': config,
            'score': float(score),
    ...
    print(f"\nResults saved to full_test_minimal_output.json")
