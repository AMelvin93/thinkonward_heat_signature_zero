"""Full 80-sample test of reduced config (2pert_nm2)."""
...
def main():
    ...
    config = {
        ...
        'n_perturbations': 2,
        'perturb_nm_iters': 2,  # Reduced from 3
    ...
    print("="*70)
    print("FULL 80-SAMPLE TEST: 2-pert + nm2 (reduced)")
    print("="*70)
    ...
    print("="*70)
    print("RESULTS: 2-pert + nm2 (reduced)")
    print("="*70)
    ...
    # Compare with previous 4-pert result
    print(f"\nComparison with 4-pert + nm2:")
    print(f"  Score: {score:.4f} vs 1.1546 (4-pert)")
    print(f"  Time: {projected_400:.1f} vs 70.9 min (4-pert)")

    with open('full_test_reduced_output.json', 'w') as f:
        json.dump({
            'config': config,
            'score': float(score),
    ...
    print(f"\nResults saved to full_test_reduced_output.json")
