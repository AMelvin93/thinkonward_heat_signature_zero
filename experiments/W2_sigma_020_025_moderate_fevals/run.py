#!/usr/bin/env python3
"""
Run script for W2 Sigma 0.20/0.25 + Moderate Fevals optimizer.

EXP030: sigma_0.20_0.25_moderate_fevals
Config:
...
Hypothesis: Moderate fevals reduction with best sigma - less aggressive than EXP029.
Based on: EXP028 showed 16/30 fevals with sigma 0.18/0.22 gave 1.1171 @ 58.1 min. Try same fevals with better sigma.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Run W2 Sigma 0.20/0.25 + Moderate Fevals')
    parser.add_argument('--workers', type=int, default=7)
    parser.add_argument('--max-samples', type=int, default=None)
    parser.add_argument('--shuffle', action='store_true')
    parser.add_argument('--seed', type=int, default=42)
    # Key experiment parameters - EXP030 specific
    ...
    print(f"\n[W2] Sigma 0.20/0.25 + Moderate Fevals Optimizer")
    print(f"=" * 70)
    print(f"EXP030: sigma_0.20_0.25_moderate_fevals")
    print(f"-" * 70)
    ...
    print(f"\n{'='*70}")
    print(f"RESULTS: [W2] Sigma 0.20/0.25 + Moderate Fevals (EXP030)")
    print(f"{'='*70}")
    ...
    print()
    print(f"Config: sigma={args.sigma0_1src}/{args.sigma0_2src} (BEST), fevals={args.max_fevals_1src}/{args.max_fevals_2src} (REDUCED)")
    print(f"Baseline: 1.1247 @ 57.2 min (sigma 0.15/0.20, fevals 20/36)")
    print(f"EXP002 (sigma 0.20/0.25, fevals 20/36): 1.1362 @ 69.2 min")
    print(f"EXP028 (sigma 0.18/0.22, fevals 16/30): 1.1171 @ 58.1 min")
    print(f"Target: ~55-60 min with score > baseline (1.1247)")
