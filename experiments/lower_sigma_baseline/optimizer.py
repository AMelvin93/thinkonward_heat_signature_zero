"""
Lower Sigma Optimizer - Testing tighter initial search

Based on early_timestep_filtering optimizer but with configurable sigma parameters.
...
class LowerSigmaOptimizer:
    """
    Optimizer with configurable sigma parameters for testing tighter search.

    Key difference from baseline:
    - Configurable sigma0_1src and sigma0_2src
    - Baseline uses 0.15/0.20, this experiment tests 0.15/0.18
    """
    ...
    def __init__(
        ...
        sigma0_1src: float = 0.15,  # Configurable
        sigma0_2src: float = 0.18,  # Configurable (baseline: 0.20)
