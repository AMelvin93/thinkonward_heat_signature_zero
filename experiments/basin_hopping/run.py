#!/usr/bin/env python3
"""
Run script for Basin Hopping optimizer.
"""
...
def process_single_sample(args):
    ...
    optimizer = BasinHoppingOptimizer(
        ...
        minimizer_maxiter=config['minimizer_maxiter'],
...
def main():
    parser = argparse.ArgumentParser(description='Run Basin Hopping optimizer')
    parser.add_argument('--workers', type=int, default=7)
    parser.add_argument('--max-samples', type=int, default=None)
    parser.add_argument('--shuffle', action='store_true')
    parser.add_argument('--niter', type=int, default=15, help='Basin hopping iterations')
    parser.add_argument('--T', type=float, default=0.5, help='Temperature parameter')
    parser.add_argument('--stepsize', type=float, default=0.2, help='Step size for perturbation')
    parser.add_argument('--minimizer-maxiter', type=int, default=20, help='Max L-BFGS-B iterations')
    parser.add_argument('--n-restarts', type=int, default=3, help='Number of starting points')
    ...
    print(f"Basin hopping: niter={args.niter}, T={args.T}, stepsize={args.stepsize}")
    print(f"L-BFGS-B: maxiter={args.minimizer_maxiter}")
    ...
    abandon = score < 1.08 or projected_400 > 65
