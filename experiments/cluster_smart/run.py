#!/usr/bin/env python3
"""
Run script for Cluster-Smart optimizer.
"""
...
from optimizer import ClusterSmartOptimizer


def process_single_sample(args):
    idx, sample, meta, config = args
    optimizer = ClusterSmartOptimizer(
...
def main():
    parser = argparse.ArgumentParser(description='Run Cluster-Smart optimizer')
    ...
    print(f"Key: Use cluster init instead of smart init for 2-source")
    print(f"=" * 60)
