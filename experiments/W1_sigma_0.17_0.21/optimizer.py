...
class Sigma017021Optimizer:
    """
    Optimizer with sigma 0.17/0.21.

    EXP013 Config:
    - sigma0_1src: 0.17 (between baseline 0.15 and intermediate 0.18)
    - sigma0_2src: 0.21 (between baseline 0.20 and intermediate 0.22)
    - threshold_1src: 0.35
    - threshold_2src: 0.45
    - fevals_1src: 20
    - fevals_2src: 36
    ...
    Hypothesis: Sigma 0.17/0.21 should give ~60 min timing (interpolated from
    baseline 57 min and intermediate 63.5 min) with score improvement.
    """
    ...
    def __init__(
        ...
        sigma0_1src: float = 0.17,       # Between baseline and intermediate
        sigma0_2src: float = 0.21,       # Between baseline and intermediate
