#!/usr/bin/env python3
"""
Run script for W2 Sigma 0.19/0.24 optimizer.

EXP021: sigma_0.19_0.24
Config:
- sigma0_1src: 0.19 (between 0.18 and 0.20)
- sigma0_2src: 0.24 (between 0.22 and 0.25)
- threshold_1src: 0.35 (standard)
- threshold_2src: 0.45 (standard)
- fallback_fevals: 18

Hypothesis: Sigma 0.19/0.24 may find optimal balance between 0.18 (1.1337) and 0.20 (1.1362).
Based on: Exploring sweet spot between sigma 0.18/0.22 and 0.20/0.25 which both work.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Run W2 Sigma 0.19/0.24 optimizer')
    parser.add_argument('--workers', type=int, default=7)
    parser.add_argument('--max-samples', type=int, default=None)
    parser.add_argument('--shuffle', action='store_true')
    parser.add_argument('--seed', type=int, default=42)
    # Key experiment parameters - EXP021 specific
    parser.add_argument('--sigma0-1src', type=float, default=0.19)  # Between 0.18 and 0.20
    parser.add_argument('--sigma0-2src', type=float, default=0.24)  # Between 0.22 and 0.25
    ...
    print(f"\n[W2] Sigma 0.19/0.24 Optimizer")
    print(f"=" * 70)
    print(f"EXP021: sigma_0.19_0.24")
    print(f"-" * 70)
    ...
    print(f"\n{'='*70}")
    print(f"RESULTS: [W2] Sigma 0.19/0.24 (EXP021)")
    print(f"{'='*70}")
    ...
    print(f"EXP002 (sigma 0.20/0.25): 1.1362 @ 69.2 min")
    print(f"EXP010 (sigma 0.18/0.22): 1.1337 @ 63.5 min")
