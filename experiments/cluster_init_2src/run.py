#!/usr/bin/env python3
"""
Run script for Cluster Init 2-Source optimizer.
"""
...
from optimizer import ClusterInit2srcOptimizer


def process_single_sample(args):
    idx, sample, meta, config = args
    optimizer = ClusterInit2srcOptimizer(
...
def main():
    parser = argparse.ArgumentParser(description='Run Cluster Init 2-Source optimizer')
    ...
    print(f"\nCluster Init 2-Source Optimizer")
    print(f"=" * 60)
