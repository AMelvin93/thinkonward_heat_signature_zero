"""
Run 3: Intermediate sigma (0.16/0.20) with fevals 22/40.
"""
...
def run_experiment(config, config_name, data):
    ...
    print(f"Baseline: 1.173 @ 50.4 min, Delta: {score - 1.173:+.4f} score")
...
def main():
    ...
    # Intermediate sigma with higher fevals
    config = {
        'sigma0_1src': 0.16,
        'sigma0_2src': 0.20,
        'max_fevals_1src': 22,
    ...
    result = run_experiment(config, 'sigma_016_020_fevals_22_40', data)
