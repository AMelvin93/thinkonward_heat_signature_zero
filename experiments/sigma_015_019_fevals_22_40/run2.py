"""
Run 2: Try higher perturbation count to restore diversity.
"""
...
def main():
    print("="*70)
    print("Run 2: Try 3 perturbations to restore diversity")
    print("="*70)

    data = load_data()
    print(f"Loaded {len(data['samples'])} samples")

    # Config with 3 perturbations instead of 2
    config = {
        'sigma0_1src': 0.15,
        'sigma0_2src': 0.19,
        'max_fevals_1src': 22,
    ...
    result = run_experiment(config, 'fevals_22_40_3perturb', data)
