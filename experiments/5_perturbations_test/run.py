"""
Experiment: 5_perturbations_test

Test if 5 perturbations can fit in budget while improving score.
Current 4pert_nm2: 1.1482 @ 51.7 min (8.3 min remaining)

Hypothesis: One more perturbation might use ~3-4 min and improve diversity/score.
"""
...
def main():
    ...
    BASELINE_4PERT = 1.1482  # 4pert_nm2 validated
    BASELINE_TIME = 51.7

    # Test config: 5 perturbations (1 more than 4pert_nm2)
    config = {
        'sigma0_1src': 0.18,
        'sigma0_2src': 0.22,
        'max_fevals_1src': 20,
        ...
        'n_perturbations': 5,             # 5 perturbations (was 4)
        'perturb_nm_iters': 2,
    ...
    if result['in_budget'] and result['score'] > BASELINE_4PERT:
        print("\n*** SUCCESS! 5 perturbations improves score within budget. ***")
        decision = "SUCCESS"
        ...
        print("\n*** OVER BUDGET - 5 perturbations cannot fit. ***")
