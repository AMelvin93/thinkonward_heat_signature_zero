#!/usr/bin/env python
"""Run A9: L-BFGS-B Gradient-Based Optimizer experiment."""
...
from experiments.lbfgs_optimizer.optimizer import (
    LBFGSOptimizer,
...
def main():
    parser = argparse.ArgumentParser(description='Run L-BFGS-B Optimizer')
    ...
    print("=" * 70)
    print("A9: L-BFGS-B Gradient-Based Optimizer")
    print("=" * 70)
    ...
    if is_g4dn_simulation and not args.max_samples:
        ...
        run_name = f"lbfgs_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
