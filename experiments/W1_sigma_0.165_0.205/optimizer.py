"""
W1 Sigma 0.165/0.205 Optimizer.
...
class Sigma0165_0205Optimizer:
    """
    Optimizer with sigma 0.165/0.205 - fine-tuned for ~59 min budget.

    EXP016 Config:
    - sigma0_1src: 0.165 (halfway between baseline 0.15 and 0.17)
    - sigma0_2src: 0.205 (halfway between baseline 0.20 and 0.21)
    - threshold_1src: 0.35
    - threshold_2src: 0.45
    - fevals_1src: 20
    - fevals_2src: 36
    ...
    def __init__(
        ...
        sigma0_1src: float = 0.165,      # Fine-tuned
        sigma0_2src: float = 0.205,      # Fine-tuned
