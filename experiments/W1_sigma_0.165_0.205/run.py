#!/usr/bin/env python3
"""
Run script for W1 Sigma 0.165/0.205 optimizer.

EXP016: Testing sigma 0.165/0.205 - halfway between baseline and 0.17/0.21.
Target: ~59 min timing with some score benefit over baseline.
...
from optimizer import Sigma0165_0205Optimizer


def process_single_sample(args):
    idx, sample, meta, config = args
    optimizer = Sigma0165_0205Optimizer(
...
def main():
    parser = argparse.ArgumentParser(description='Run W1 Sigma 0.165/0.205 optimizer')
    ...
    parser.add_argument('--sigma0-1src', type=float, default=0.165)
    parser.add_argument('--sigma0-2src', type=float, default=0.205)
    ...
    print(f"\nW1 Sigma 0.165/0.205 Optimizer (EXP016)")
    print(f"=" * 60)
    ...
    print(f"\n{'='*70}")
    print(f"RESULTS: W1 Sigma 0.165/0.205 (EXP016)")
    print(f"{'='*70}")
    ...
    print(f"Target:    ~59 min (halfway between baseline and 0.17/0.21)")
    print(f"This run:  {score:.4f} @ {projected_400:.1f} min (sigma 0.165/0.205)")
