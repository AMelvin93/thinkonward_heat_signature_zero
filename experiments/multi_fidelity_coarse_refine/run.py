#!/usr/bin/env python3
"""
Run script for Multi-Fidelity + Coarse-Grid Refinement experiment.
...
def main():
    parser = argparse.ArgumentParser(description='Run Multi-Fidelity + Coarse Refinement')
    ...
    print(f"\nMulti-Fidelity + Coarse-Grid Refinement")
    print(f"=" * 60)
    ...
    print(f"Baseline: 1.0957 @ 58.3 min | Best: 1.1094 @ 44.1 min")
    print(f"Delta vs Best: {score - 1.1094:+.4f} score, {projected_400 - 44.1:+.1f} min")
    if projected_400 > 60:
        print("❌ OVER BUDGET")
    elif score > 1.1094:
        print("✅ IMPROVED!")
