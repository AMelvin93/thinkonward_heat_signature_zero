"""
Test higher CMA-ES fevals with coordinate refinement.

Based on finding that nm6_coord001 @ 1.1602, 57.6 min is the best in-budget config,
we test if higher fevals (25/45 vs 20/36) can improve accuracy using the 2.4 min
time buffer.
"""
...
def main():
    ...
    # Base config from nm6_coord001 (best in-budget)
    base_config = {
        'sigma0_1src': 0.18,
        'sigma0_2src': 0.22,
    ...
    # Test different fevals settings
    configs = [
        ...
        ({**base_config, 'max_fevals_1src': 20, 'max_fevals_2src': 36}, 'fevals_20_36_baseline'),
    ]
