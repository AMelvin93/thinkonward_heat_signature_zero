"""
Run script for tighter_sigma_range experiment.

Tests tighter sigma values (0.16/0.20, 0.17/0.21) vs baseline (0.18/0.22).
Hypothesis: Tighter sigma allows faster local convergence.
"""
...
def main():
    ...
    # Base config from best known (hopping_with_tabu_memory no_tabu_baseline)
    base_config = {
    ...
    # Test configurations
    configs = [
        # Run 1: Tightest sigma
        {**base_config, 'sigma0_1src': 0.16, 'sigma0_2src': 0.20},
        # Run 2: Intermediate
        {**base_config, 'sigma0_1src': 0.17, 'sigma0_2src': 0.21},
        # Run 3: Baseline
        {**base_config, 'sigma0_1src': 0.18, 'sigma0_2src': 0.22},
    ]

    config_names = ['sigma_016_020', 'sigma_017_021', 'sigma_018_022_baseline']
