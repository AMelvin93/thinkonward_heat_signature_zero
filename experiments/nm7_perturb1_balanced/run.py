"""
Experiment: nm7_perturb1_balanced
Test 7 NM + 1 perturbation approach.

Current best: 8 NM + 4 perturbations = 1.1437 @ 42.2 min
"""
...
def run_experiment(config, run_num, data):
    ...
    print(f"\n=== Run {run_num}: 7 NM + 1 perturbation ===")
...
def main():
    ...
    # Config: 7 NM + 1 perturbation (with our optimized sigma/fevals)
    config = {
        'sigma0_1src': 0.18,
        'sigma0_2src': 0.22,
        'max_fevals_1src': 20,
    ...
    print("\n" + "="*60)
    print("SUMMARY: 7 NM + 1 Perturbation")
    print("="*60)
    print(f"Current best (8 NM + 4 perturb): 1.1437 @ 42.2 min")
    print()
    for r in results:
