"""
Optimizer combining optimal sigma (0.15/0.19) with coordinate refinement.

From tighter_sigma_range: sigma 0.15/0.19 achieves 1.1730 with perturbation.
From coordinate_wise_refinement: coord refine gives +0.0105 improvement.

Hypothesis: Coord refinement with optimal sigma might match or beat perturbation.
"""
...
class SigmaCoordRefineOptimizer:
    """
    Optimizer with optimal sigma + coordinate refinement.
    """
    ...
    def __init__(
        ...
        sigma0_1src: float = 0.15,  # OPTIMAL from tighter_sigma_range
        sigma0_2src: float = 0.19,  # OPTIMAL from tighter_sigma_range
