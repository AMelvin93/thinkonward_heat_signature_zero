#!/usr/bin/env python3
"""
Run script for W2 Sigma 0.16/0.20 optimizer.

EXP014: sigma_0.16_0.20_thresholds
Config:
- sigma0_1src: 0.16 (slightly higher than baseline 0.15)
- sigma0_2src: 0.20 (same as baseline)
- threshold_1src: 0.35 (aggressive)
- threshold_2src: 0.45 (aggressive)
- fallback_fevals: 18

Hypothesis: Slightly higher sigma (0.16/0.20) than baseline may give score benefit with minimal time cost (~58 min).
Based on: Testing minimum sigma increase that provides score benefit while staying in budget.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Run W2 Sigma 0.16/0.20 optimizer')
    parser.add_argument('--workers', type=int, default=7)
    parser.add_argument('--max-samples', type=int, default=None)
    parser.add_argument('--shuffle', action='store_true')
    parser.add_argument('--seed', type=int, default=42)
    # Key experiment parameters - EXP014 specific
    parser.add_argument('--sigma0-1src', type=float, default=0.16)  # Slightly higher than baseline
    parser.add_argument('--sigma0-2src', type=float, default=0.20)  # Same as baseline
    ...
    print(f"\n[W2] Sigma 0.16/0.20 Optimizer")
    print(f"=" * 70)
    print(f"EXP014: sigma_0.16_0.20_thresholds")
    print(f"-" * 70)
    ...
    print(f"\n{'='*70}")
    print(f"RESULTS: [W2] Sigma 0.16/0.20 (EXP014)")
    print(f"{'='*70}")
    ...
    print()
    print(f"Config: sigma={args.sigma0_1src}/{args.sigma0_2src}")
