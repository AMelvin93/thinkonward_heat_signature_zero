#!/usr/bin/env python3
"""
Run script for Tri-Smart-Cluster optimizer.
"""
...
from optimizer import TriSmartClusterOptimizer


def process_single_sample(args):
    idx, sample, meta, config = args
    optimizer = TriSmartClusterOptimizer(
...
def main():
    parser = argparse.ArgumentParser(description='Run Tri-Smart-Cluster optimizer')
    ...
    print(f"Key: 3 inits for 2-src (tri + smart + cluster)")
    print(f"=" * 60)
