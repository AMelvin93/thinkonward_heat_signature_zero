"""
Tri-Smart-Cluster Optimizer.

Key idea: Use 3 initializations for 2-source problems:
- triangulation
- smart (hottest sensors)
- cluster (K-means on temperatures)

With 36 fevals total, allocate 12 fevals per init.
This gives better coverage of the search space without adding overhead.
"""
...
class TriSmartClusterOptimizer:
    """
    Uses 3 inits for 2-source: tri + smart + cluster.
    """
