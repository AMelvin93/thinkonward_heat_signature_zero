"""
Run 4: Push 2src fevals even higher (20/48)

Run 2 (20/44) outperformed Run 3 (20/36). Try 20/48 to see if more 2src fevals helps.
We have time budget: Run 2 was 41.7 min, so ~18 min buffer to use.
"""
...
def main():
    ...
    # Run 4: Even higher 2src fevals (20/48)
    config = {
        'sigma0_1src': 0.18,
        'sigma0_2src': 0.22,
        'max_fevals_1src': 20,
        'max_fevals_2src': 48,  # Higher than Run 2's 44
    ...
    result = run_experiment(config, 'sigma_018_fevals_20_48', data)
