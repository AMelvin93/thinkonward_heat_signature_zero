"""
Run 3: Standard fevals (20/36) with sigma 0.18/0.22

Compare with Run 2 (20/44) to see if higher 2src fevals helps.
"""
...
def main():
    ...
    # Run 3: Standard fevals (20/36) for comparison
    config = {
        'sigma0_1src': 0.18,
        'sigma0_2src': 0.22,
        'max_fevals_1src': 20,  # Standard
        'max_fevals_2src': 36,  # Standard (vs 44 in Run 2)
    ...
    result = run_experiment(config, 'sigma_018_fevals_20_36', data)
