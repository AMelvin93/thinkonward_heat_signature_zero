"""
Run 2: Lower 1src fevals to preserve diversity

Run 1 showed 1-src candidates dropped to 2.28. Try reducing 1src fevals to 20 to preserve diversity.
"""
...
def main():
    ...
    config = {
        'sigma0_1src': 0.18,
        'sigma0_2src': 0.22,
        'max_fevals_1src': 20,  # Reduced from 24
        'max_fevals_2src': 44,  # Keep higher 2src fevals
    ...
    result = run_experiment(config, 'sigma_018_fevals_20_44', data)
