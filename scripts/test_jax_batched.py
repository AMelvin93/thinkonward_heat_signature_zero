#!/usr/bin/env python
"""
Test script for JAX Batched Optimizer (vmap parallel finite differences).

Run from WSL: uv run python scripts/test_jax_batched.py
"""
...
from jax_batched_optimizer import JAXBatchedOptimizer, check_gpu
import numpy as np


def main():
    print("=" * 60)
    print("JAX BATCHED OPTIMIZER TEST (vmap parallel finite diff)")
    print("=" * 60)
